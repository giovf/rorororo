...
| --- | --- | --- | --- |
| **Datarade** (datarade.ai) | **Applied 2026-09-20** (owner; awaiting review) | Application reviewed for fit; free "Standard" plan; buyers browse, request samples, post data requests and message providers in-platform. Sales-led (someone answers messages), but inbound only. | Free listing; 30% commission on deals Datarade facilitates. Direct deals off-platform are ours. |
