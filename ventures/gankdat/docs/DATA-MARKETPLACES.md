...
| --- | --- | --- | --- |
| **Datarade** (datarade.ai) | **Rejected 2026-09-21** — registered businesses only, no sole proprietors | Application reviewed for fit; free "Standard" plan; buyers browse, request samples, post data requests and message providers in-platform. Sales-led (someone answers messages), but inbound only. | Free listing; 30% commission on deals Datarade facilitates. Direct deals off-platform are ours. |
