...
Private by design: ReadFocus collects no data and makes no network requests while you read. The only request it ever makes is a one-time check when you activate a paid key. Settings live in your browser's extension storage.
